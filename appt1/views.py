        ...
        return render(request,'estacao/DataConfirmada.html',AsDatas)
           ...
           context = {
              'temperatura': t[-1], 
               ...
               'tempMax':"{:.2f}".format(max(float(tmax))),
               'tempMin':"{:.2f}".format(min(float(tmin))),
               'humMax':"{:.2f}".format(max(float(hmax))),
               'humMin':"{:.2f}".format(min(float(hmin))),
               'presMax':"{:.2f}".format(max(float(pmax))),
               'presMin':"{:.2f}".format(min(float(pmin))),
               'venMax':"{:.2f}".format(max(float(vmax))),
               'venMin':"{:.2f}".format(min(float(vmin))),
               'luzMax':"{:.2f}".format(max(float(lmax))),
               'luzMin':"{:.2f}".format(min(float(lmin))),
               'rpmMax':"{:.2f}".format(max(float(rmax))),
               'rpmMin':"{:.2f}".format(min(float(rmin))),
               'gasMax':"{:.2f}".format(max(float(gmax))),
               'gasMin':"{:.2f}".format(min(float(gmin))),
               'qarMax':"{:.2f}".format(max(float(qmax))),
               'qarMin':"{:.2f}".format(min(float(qmin))),
               'img_t': img_t,
               'img_u': img_u,
               'img_gas': img_gas,
               'img_ar': img_ar,
